const data = {
    Questions: {
        ...
        formatSoftware: "[ERC, H2020] What methods or software tools are needed to access data files in private format? Is documentation about the software needed to open the data file provided in the metadata? Is it possible to provide the relevant software (e.g. in open source code)?",
        ...
        sharingRepos: "[FWO, ERC, H2020] List the repositories in which data, metadata, code, software and related documentation will be shared.",
        datasetsEmbargo: "[FWO, ERC, H2020] Per dataset, state when it will be made available. Is embargo forseen?",
        datasetsLicense: "[ERC, H2020] Per dataset, state how it will be licensed to permit the widest reuse possible. If the re-use of some data is restricted, explain why and specify the length of time for which the data will remain re-usable.",
        ...
        datasetsMetadata: "[FWO, ERC, H2020] Will a metadata schema be used? Per dataset, state the metadata standards or the customized metadata that will be used.",
        ...
        datasetsOntology: "[ERC, H2020] Will you use a controlled vocabulary or standard ontology to describe your data? Per dataset, state the standard ontologies you will use or the mapping of your vocabulary to a standard ontologies.",
        ...
        costsFair: "[H2020] What are the estimated costs for making data FAIR?",
        ...
        storageDuringFrequency: "[FWO, ERC, H2020] What is the backup frequency?",
        ...
        securityDuring: "[FWO, ERC, H2020] Data security: how will you ensure that the data are securely stored (not accessed or modified by unauthorized persons), especially for sensitive data.",
        datasetsListArchiving: "[FWO, ERC, H2020] List which datasets will be preserved or not, for at least 10 years after the end of the project and explain why (legal, contractual restrictions etc..)",
        ...
        costDuringCover: "[FWO, ERC, H2020] How will these costs (for data storage and backup during the project) will be covered?"
    },
    fwo: {
        sections: {
            dataDescription: {
